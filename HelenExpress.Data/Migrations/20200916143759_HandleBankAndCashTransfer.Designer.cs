...
namespace HelenExpress.Data.Migrations
{
    ...
    [Migration("20200916143759_HandleBankAndCashTransfer")]
    partial class HandleBankAndCashTransfer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HelenExpress.Data.Entities.Bill", b =>
                {
                    ...
                    b.Property<double?>("OldPurchasePriceAfterVatInUsd")
                        .HasColumnName("oldpurchasepriceaftervatinusd")
                        .HasColumnType("double precision");

                    b.Property<int?>("OldPurchasePriceAfterVatInVnd")
                        .HasColumnName("oldpurchasepriceaftervatinvnd")
                        .HasColumnType("integer");

                    b.Property<double?>("OldPurchasePriceInUsd")
                        .HasColumnName("oldpurchasepriceinusd")
                        .HasColumnType("double precision");
                    ...
                    b.Property<double?>("OtherCustomerPaymentAmount")
                        .HasColumnName("othercustomerpaymentamount")
                        .HasColumnType("double precision");
                    ...
                    b.Property<string>("ReceiverNameNonUnicode")
                        .HasColumnName("receivernamenonunicode")
                        .HasColumnType("citext");
                    ...
                    b.Property<string>("SenderNameNonUnicode")
                        .HasColumnName("sendernamenonunicode")
                        .HasColumnType("citext");
                    ...
                    b.HasIndex("ReceiverName")
                        .HasName("ix_bill_receivername");

                    b.HasIndex("ReceiverNameNonUnicode")
                        .HasName("ix_bill_receivernamenonunicode");

                    b.HasIndex("SenderId")
                        .HasName("ix_bill_senderid");

                    b.HasIndex("SenderName")
                        .HasName("ix_bill_sendername");

                    b.HasIndex("SenderNameNonUnicode")
                        .HasName("ix_bill_sendernamenonunicode");
            ...
            modelBuilder.Entity("HelenExpress.Data.Entities.Customer", b =>
                {
                    ...
                    b.HasIndex("NameNonUnicode")
                        .HasName("ix_customer_namenonunicode");
            ...
            modelBuilder.Entity("HelenExpress.Data.Entities.ParcelService", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_parcelservice");

                    b.HasIndex("Name")
                        .IsUnique()
                        .HasName("ix_parcelservice_name");

                    b.ToTable("parcelservice");
                });

            modelBuilder.Entity("HelenExpress.Data.Entities.ParcelServiceVendor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.Property<Guid>("ParcelServiceId")
                        .HasColumnName("parcelserviceid")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_parcelservicevendor");

                    b.HasIndex("VendorId")
                        .HasName("ix_parcelservicevendor_vendorid");

                    b.HasIndex("ParcelServiceId", "VendorId")
                        .IsUnique()
                        .HasName("ix_parcelservicevendor_parcelserviceid_vendorid");

                    b.ToTable("parcelservicevendor");
                });
            ...
            modelBuilder.Entity("HelenExpress.Data.Entities.ParcelServiceZone", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_parcelservicezone");

                    b.HasIndex("ParcelServiceId")
                        .HasName("ix_parcelservicezone_parcelserviceid");

                    b.HasIndex("Name", "ParcelServiceId")
                        .IsUnique()
                        .HasName("ix_parcelservicezone_name_parcelserviceid");
            ...
            modelBuilder.Entity("HelenExpress.Data.Entities.ParcelServiceVendor", b =>
                {
                    b.HasOne("HelenExpress.Data.Entities.ParcelService", "ParcelService")
                        .WithMany("ParcelServiceVendors")
                        .HasForeignKey("ParcelServiceId")
                        .HasConstraintName("fk_parcelservicevendor_parcelservice_parcelserviceid")
                    ...
                    b.HasOne("HelenExpress.Data.Entities.Vendor", "Vendor")
                        .WithMany("ParcelServiceVendors")
                        .HasForeignKey("VendorId")
                        .HasConstraintName("fk_parcelservicevendor_vendors_vendorid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
