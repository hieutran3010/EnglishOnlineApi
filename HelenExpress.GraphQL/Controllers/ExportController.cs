    ...
    public class ExportController : ControllerBase
    {
        ...
        private readonly IDictionary<string, ExcelFieldDefinition> billReportHeaderMappings =
            new Dictionary<string, ExcelFieldDefinition>
            {
                ...
                {"CustomerPaymentAmount", new ExcelFieldDefinition("KHTT - Đã Trả (TM)") {FieldType = typeof(double)}},
                {"OtherCustomerPaymentAmount", new ExcelFieldDefinition("KHTT - Đã Trả (CK)") {FieldType = typeof(double)}},
